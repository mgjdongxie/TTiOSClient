...
- (NSString*)getNewMessageContentFromContent:(NSString*)content
{
    ...
    NSRange startRange;
    NSDictionary* emotionDic = [DDEmotionsModule shareInstance].emotionUnicodeDic;
...
+(DDMessageEntity *)makeMessage:(NSString *)content Module:(DDChattingModule *)module MsgType:(DDMessageType )type
{
