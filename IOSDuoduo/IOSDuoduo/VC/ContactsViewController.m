...
@property(strong)DDContactAvatarTools *tools;
...
-(IBAction)showActions:(id)sender
{
    ...
    self.tools = [[DDContactAvatarTools alloc] initWithFrame:CGRectMake(rect.origin.x+btn.frame.size.width+5, rect.origin.y-70, 100, 100)];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        DDChattingMainViewController *main = [DDChattingMainViewController shareInstance];
