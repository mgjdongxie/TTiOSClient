...
#import "DDImagesPreviewViewController.h"
...
@end
@interface DDImagesPreviewViewController ()
@property(nonatomic,strong)NSMutableArray *photos;
@property(nonatomic,strong) MWPhotoBrowser *photoBrowser;
@property(nonatomic,strong)UIButton *button;
@end
@implementation DDImagesPreviewViewController
{
...
- (void)viewDidLoad
{
    ...
    [self.button setBackgroundImage:[UIImage imageWithName:@"dd_image_send"] forState:UIControlStateNormal];
    [self.button setBackgroundImage:[UIImage imageWithName:@"dd_image_send"] forState:UIControlStateSelected];
    ...
    [backButton setImage:[UIImage imageWithName:@"dd_image_back"] forState:UIControlStateNormal];
...
-(IBAction)sendPhotos:(id)sender
{
    ...
    [HUD showAnimated:YES whileExecutingBlock:^{
        ...
        [self.navigationController popToViewController:[DDChattingMainViewController shareInstance] animated:YES];
    }];
