...
@implementation DDAlbumDetailsBottomBar
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self.send setBackgroundImage:[UIImage imageWithName:@"dd_image_send"] forState:UIControlStateNormal];
        [self.send setBackgroundImage:[UIImage imageWithName:@"dd_image_send"] forState:UIControlStateSelected];
