...
- (void)setContent:(DDMessageEntity *)content
{
    ...
    switch (self.location) {
        case DDBubbleLeft:
            imageArray = @[[UIImage imageWithName:@"dd_left_voice_one"],[UIImage imageWithName:@"dd_left_voice_two"],[UIImage imageWithName:@"dd_left_voice_three"]];
            [_voiceImageView setContentMode:UIViewContentModeLeft];
            [_voiceImageView setImage:[UIImage imageWithName:@"dd_left_voice_three"]];
            break;
        case DDBubbleRight:
            imageArray = @[[UIImage imageWithName:@"dd_right_voice_one"],[UIImage imageWithName:@"dd_right_voice_two"],[UIImage imageWithName:@"dd_right_voice_three"]];
            [_voiceImageView setContentMode:UIViewContentModeRight];
            [_voiceImageView setImage:[UIImage imageWithName:@"dd_right_voice_three"]];
