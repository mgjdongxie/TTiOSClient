...
@interface DDChatBaseCell : UITableViewCell<DDMenuImageViewDelegate,UIAlertViewDelegate>
@property (nonatomic,assign)DDBubbleLocationType location;
@property (nonatomic,retain)DDMenuImageView* bubbleImageView;
