...
CGFloat const dd_avatarBubbleGap = 16;             //头像和气泡之间的距离
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.bubbleImageView = [[DDMenuImageView alloc] initWithFrame:CGRectMake(0, 0, 0, 0)];
        ...
        [self.sendFailuredImageView setImage:[UIImage imageWithName:@"dd_send_failed"]];
...
- (void)setContent:(DDMessageEntity*)content
{
    ...
    [[DDUserModule shareInstance] getUserForUserID:content.senderId Block:^(DDUserEntity *user) {
        NSURL* avatarURL = [NSURL URLWithString:user.avatar];
         [self.userAvatar setImageWithURL:avatarURL placeholderImage:[UIImage imageWithName:@"user_placeholder"]];
