...
#import "DDAlbumDetailsBottomBar.h"
...
- (void)viewDidLoad
{
    ...
    self.bar = [[DDAlbumDetailsBottomBar alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height-70, 320, 45)];
    ...
    self.bar.Block=^(int buttonIndex){
        if (buttonIndex == 0) {
            ...
            DDImagesPreviewViewController *photoPreview = [DDImagesPreviewViewController new];
        ...
        }else
        {
            ...
            if ([weakSelf.choosePhotosArray count] >0) {
                ...
                [HUD showAnimated:YES whileExecutingBlock:^{
                    ...
                    [weakSelf.navigationController popToViewController:[DDChattingMainViewController shareInstance] animated:YES];
                }];
            }
        }
    };
