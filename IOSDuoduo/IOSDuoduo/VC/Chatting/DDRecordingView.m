...
@interface DDRecordingView(PrivateAPI)
...
@implementation DDRecordingView
...
- (void)setupCancelSendView
{
    ...
    UIImage* image = [UIImage imageWithName:@"dd_cancel_send_record"];
...
- (void)setupShowVolumnState
{
    ...
    UIImage* image = [UIImage imageWithName:@"dd_recording"];
    UIImageView* imageView = [[UIImageView alloc] initWithImage:image];
    ...
    UIImage* volumnImage = [UIImage imageWithName:@"dd_volumn"];
...
- (void)setupShowRecordingTooShort
{
    ...
    UIImage* image = [UIImage imageWithName:@"dd_record_too_short"];
    UIImageView* imageView = [[UIImageView alloc] initWithImage:image];
